    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String text= """
                Przydatne skróty:
                    ...
                    Proponowane skróty:
                        alt shift f5 = nowa klasa Javy
                        alt shift f6 = nowa klasa/plik Kotlina
                        shift f5 = nowy pakiet

                Przydatne makra:

                    main = definicja metody/funkcji main (Java/Kotlin
                    maina = definicja funkcji main z argumentami (Kotlin)
                    sout = Jav: System.out.println(); Kotlin: println()
